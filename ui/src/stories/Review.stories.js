...
storiesOf("Review", module)
  .add("with images", () => {
    FetchMock.restore()
    const ratings = [
      { userId: 1, imageBase64: testImage, username: "User1", votes: 1},
      { userId: 2, imageBase64: testImage, username: "User2", votes: 2}
    ];
